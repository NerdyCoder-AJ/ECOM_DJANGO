...
gateway = braintree.BraintreeGateway(
    braintree.Configuration(
        ...
        merchant_id="qfs7y8sc9y892chf",
        public_key="n36srcdjw97vdjrs",
        private_key="8cf422e0ea9326e6764a22e0d3b08a7e"
    )
)
...
def genrate_token(request, id, token):
    if not validate_user_session(id, token):
        return JsonResponse({'error': 'Invalid Session, Plese login again!'})
    return JsonResponse({
